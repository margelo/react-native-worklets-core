...
export class ModuleNotFoundError extends Error {
  constructor(cause?: unknown) {
    const errorCause =
      cause instanceof Error
        ...
        : new Error(
          ...
          // TODO: this needs to be changed as this also works on the old arch!
    ...
    suggestions.push(
      "Make sure you are using react-native 0.76.0 or higher."
    );
    ...
    switch (Platform.OS) {
      ...
      default:
        suggestions.push(
          `Make sure react-native-worklets-core is supported on ${Platform.OS}.`
        );
        break;
    }
