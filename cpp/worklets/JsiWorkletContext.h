...
class JsiWorkletContext {
    ...
    */
    JsiWorkletContext(JsiWorkletContext* context): JsiWorkletContext(context->_jsRuntime,
     ...
     */
    JsiWorkletCache &getWorkletsCache() {
        return _workletsCache;
    }
    ...
    /**
     * Returns a list of shared values that are dependencies in the worklet closure
